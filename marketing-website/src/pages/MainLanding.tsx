...
const MainLanding: React.FC = () => {
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600">Loading Cursor...</p>
        </div>
      </div>
    );
  }
  ...
  const safeRender = () => {
    ...
    <div className="min-h-screen bg-white">
          ...
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              <div className="flex-shrink-0">
                <h1 className="text-2xl font-bold text-cursor-blue">Cursor</h1>
              </div>
            </div>
            <div className="hidden md:block">
              <div className="ml-10 flex items-baseline space-x-4">
                ...
                <Link to="/login" className="text-cursor-gray hover:text-cursor-blue px-3 py-2 rounded-md text-sm font-medium">
                  Login
                </Link>
              </div>
            </div>
            <div className="md:hidden">
              <button className="bg-cursor-blue text-white px-4 py-2 rounded-md text-sm font-medium">
                Get Demo
              </button>
            </div>
          </div>
      ...
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-cursor-light-gray to-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6">
            One Platform to Run All Your Studies
          </h1>
          <h2 className="text-2xl md:text-3xl font-semibold text-cursor-blue mb-8">
            Smarter, Simpler, Compliant
          </h2>
          <p className="text-xl text-cursor-gray mb-10 max-w-3xl mx-auto">
            Transform the messy, high-pressure world of site management into a seamless, organized experience. 
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button 
              ...
              onClick={() => {
                try {
                  debugLog('Get Demo button clicked');
                  // Add demo request logic here
                  alert('Demo request functionality coming soon!');
                } catch (error) {
                  debugError('Demo button click error', error);
            ...
            <button 
              className="border-2 border-cursor-blue text-cursor-blue px-8 py-4 rounded-lg text-lg font-semibold hover:bg-cursor-blue hover:text-white transition-colors"
              onClick={() => {
                try {
                  debugLog('Try for Free button clicked');
                  // Add free trial logic here
                  alert('Free trial functionality coming soon!');
                } catch (error) {
                  debugError('Free trial button click error', error);
                  alert('Sorry, there was an error. Please try again.');
                }
              }}
            >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-cursor-gray max-w-3xl mx-auto">
              Cursor's unified calendar handles all your study visits, tasks, and reminders automatically.
            </p>
          </div>
      ...
      <section className="py-20 bg-cursor-light-gray">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-cursor-gray max-w-3xl mx-auto">
              Unlike generic schedulers, Cursor is purpose-built for clinical sites – it's your calendar, 
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-cursor-gray mb-12 max-w-3xl mx-auto">
            Built with FDA 21 CFR Part 11 compliance in mind – audit trails, e-signatures, and data security are baked in from day one.
          </p>
          
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="p-6 border border-gray-200 rounded-lg">
              <div className="bg-cursor-blue bg-opacity-10 w-12 h-12 rounded-lg flex items-center justify-center mx-auto mb-4">
              ...
              <p className="text-cursor-gray text-sm">End-to-end encryption and secure data handling</p>
            </div>
            
            <div className="p-6 border border-gray-200 rounded-lg">
              <div className="bg-cursor-green bg-opacity-10 w-12 h-12 rounded-lg flex items-center justify-center mx-auto mb-4">
                <svg className="w-6 h-6 text-cursor-green" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                </svg>
              </div>
              <h3 className="text-lg font-semibold text-gray-900 mb-2">21 CFR Part 11</h3>
              <p className="text-cursor-gray text-sm">FDA-compliant electronic signatures and audit trails</p>
            </div>
            ...
            <div className="p-6 border border-gray-200 rounded-lg">
              ...
              <p className="text-cursor-gray text-sm">Enterprise-grade security and availability</p>
            </div>
          </div>
          ...
          <button 
            ...
            onClick={() => {
              try {
                debugLog('Learn More About Compliance button clicked');
                // Add compliance page navigation logic here
                alert('Compliance information page coming soon!');
              } catch (error) {
                debugError('Compliance button click error', error);
                alert('Sorry, there was an error. Please try again.');
              }
            }}
          >
      ...
      <section className="py-20 bg-cursor-light-gray">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-cursor-gray mb-12 max-w-3xl mx-auto">
            See how Cursor is transforming site operations and making coordinators' lives easier.
          </p>
          ...
          <div className="bg-white p-8 rounded-lg shadow-sm max-w-4xl mx-auto">
            ...
            <blockquote className="text-xl text-gray-900 mb-6 italic">
              "Cursor has transformed how we manage our studies. We've saved over 5 hours per week per coordinator, 
      ...
      <section className="py-20 bg-cursor-blue">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-blue-100 mb-10 max-w-3xl mx-auto">
            Join the growing number of clinical research sites that have simplified their study management with Cursor.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button 
